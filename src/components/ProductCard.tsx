...
const ProductCard: React.FC<ProductCardProps> = ({ 
  ...
  return (
    ...
    >
      <div className="relative h-64 w-full overflow-hidden bg-[#FFFF00]/50">
      ...
      <div className="p-6 bg-black text-[#FFFF00]">
        ...
        <div className="flex justify-between items-center">
          ...
          {comingSoon ? (
            <motion.button
              className="bg-gray-600 text-white px-4 py-2 rounded-lg font-bold opacity-70 cursor-not-allowed"
              whileHover={{ scale: 1 }}
            >
              Coming Soon
            </motion.button>
